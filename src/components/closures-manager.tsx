  ...
  return (
    <Card className="space-y-3">
      ...
      <p className="text-sm text-muted-foreground">
        המערכת מזהה אוטומטית את חגי ישראל: חג סוגר את היום, ערב חג עובד עד 13:00, יום העצמאות סגור,
        יום הזיכרון עד 13:00. פורים, חנוכה ותשעה באב — עבודה כרגיל. חול המועד וערב יום הזיכרון מופיעים
        ברשימה כ«עובדים כרגיל» — אפשר לסמן להם «עד 13:00» בלחיצה. כל יום ניתן לשינוי, וגם להוסיף סגירה ידנית.
      </p>
